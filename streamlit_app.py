...
def processed_img(img_path):
    print(img_path)
    img=load_img(img_path,target_size=(128,128,3)) # IMAGE_SIZE = 128 X 128 X 3
    ...
    pred = model(img)
    y_class = torch.argmax(pred)
    y_class = int(y_class.detach().numpy())
    res = lab[y_class]
    return res
...
def run():
    ...
    # st.markdown('''<h1 style='text-align: left; color: #d73b5c;'>* Data is based "400 Bird Species "</h1>''',
